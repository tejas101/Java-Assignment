/* GenericLinkedListException.java  
 *Version: 
 *     1 
 * 
 * Revisions: 
...
public class GenericLinkedListException<T extends Comparable> extends StorageImplementation<T>  {
	  Node < T > start;
      Node < T > end;
      //int size it will be in Parent class as counter;
      //int counter;
      public GenericLinkedListException() {
          start = null;
          end = null;
          //counter = 0;
      }
		...
		public boolean containsAll(T[] os) {
    	 ...
    	 public static void main(String args[]) {
    		...
    		/* System.out.println(obj.toString());
    		 ...
    		 obj.add(3, "Harshal");*/
    		 GenericLinkedListException<String> obj=new GenericLinkedListException<>();
    		 /*obj.add("1");
    		 obj.add("3");
    		 obj.add("7");
    		 obj.remove("7");
    		 System.out.println(obj);*/
    		 //obj.addAll(0, new String[]{"PQR","ABC", "Real Madrid","PQR"});
    		// obj.add("te");
    		// obj.add("oe");
    		 //obj.add("d");
    		 obj.add("ds");
    		 ...
    		 System.out.println(obj);
    		 //System.out.println(obj.removeAll(new String[]{"PQR","ss", "Rssseal Madrid","PQR"}));
    		 //System.out.println(obj);
