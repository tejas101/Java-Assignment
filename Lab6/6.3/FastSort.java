...
class Generic < E > implements StorageI < E > {
    ...
    /**
     * adds the data to 1st index with out worrying about sorting
     * @param   data data to be added in the generic
     */
    public boolean add_noSort(E data) {
    ...
    /**
     *add adds the data to 1st index in a sorted manner.
     * @param   data data to be added in the generic
     */
